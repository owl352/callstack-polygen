 ...
 */
export declare enum NativeTableElementType {
    AnyFunc = 0,
    ExternRef = 1
}
/**
 ...
 */
export declare enum NativeSymbolKind {
    Function = "function",
    Table = "table",
    Memory = "memory",
    Global = "global"
...
export interface Spec extends TurboModule {
    ...
    loadModule(holder: OpaqueModuleNativeHandle, moduleData: UnsafeArrayBuffer): InternalModuleMetadata;
    ...
    createModuleInstance(holder: OpaqueModuleInstanceNativeHandle, mod: OpaqueModuleNativeHandle, importObject: NativeImportObject): void;
    destroyModuleInstance(instance: OpaqueModuleInstanceNativeHandle): void;
    createMemory(holder: OpaqueMemoryNativeHandle, initial: number, maximum?: number): void;
    ...
    createGlobal(holder: OpaqueGlobalNativeHandle, descriptor: NativeGlobalDescriptor, initialValue: number): void;
    ...
    createTable(holder: OpaqueTableNativeHandle, descriptor: NativeTableDescriptor, initial?: unknown): void;
    ...
    setTableElement(instance: OpaqueTableNativeHandle, index: number, value: unknown): void;
    getTableSize(instance: OpaqueTableNativeHandle): number;
}
declare const _default: Spec;
export default _default;
//# sourceMappingURL=NativePolygen.d.ts.map